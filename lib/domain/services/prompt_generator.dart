...
当前章节摘要: <这里写当前章节摘要>''';
  ...
  /// 生成更新全局摘要的提示 (基于 prompt_definitions.py 的 361-377 行)
  String generateUpdateSummaryPrompt({
...
仅返回前文摘要文本，不要解释任何内容。''';
  ...
  /// 生成更新角色状态的提示 (基于 prompt_definitions.py 的 431-489 行)
  String generateUpdateCharacterStatePrompt({
    required String chapterText,
