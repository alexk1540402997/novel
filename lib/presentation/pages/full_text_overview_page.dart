...
class _FullTextOverviewPageState extends State<FullTextOverviewPage> {
  ...
  void _onNovelSelected(String? folderName) {
    ...
    if (_selectedFolder != null &&
        ...
        _globalSummaryContent != _textController.text) {
  ...
  void dispose() {
    ...
    // 注意：这里不能使用 _saveGlobalSummaryContent，因为它会调用 setState，
    ...
    if (_selectedFolder != null &&
      ...
      NovelFileService().saveGlobalSummary(_selectedFolder!, _textController.text);
    }
